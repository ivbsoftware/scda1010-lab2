# scda1010-lab2
CSDA1010SUMA18 - LAB EXERCISE 2: Regression Problem

The data set chosen for the lab is [Wine Quality Data Set](http://archive.ics.uci.edu/ml/datasets/Wine+Quality)
